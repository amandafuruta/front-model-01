...
import { FoodBody } from '@/components/styles/food'
    ...
    <>
      ...
      <HomeStyle id='homeBody'>
        <div className='body'>
          ...
          <Footer>
            <div className={`${playfair_display.className} becomeVendor`}>
...
function FoodPage() {
  return (
    <FoodBody>
      <div className='top'>
        <h1 className={playfair_display.className}>The Food Hall</h1>
        <div className='imgBox'>
          <img src="localimg3.png" alt="image" />
        </div>
      </div>
    </FoodBody>
  )
