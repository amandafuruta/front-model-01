...
import { NavStyle } from '@/components/styles/home';
import { Body, Logo, Content } from '@/components/styles/navChild';
import { useEffect } from 'react';
import { work_sans } from '../fonts'

export default function FoodPage() {
    useEffect(() => {
        document.querySelector('.food')?.setAttribute('style', ' transition: 0.5s; min-width: 90vw')
        document.querySelector('.logo')?.setAttribute('style', ' transition: left 1s; left: -3px')
    })
    ...
    return (
        <Body>
            <NavStyle>
                <Link href=''>
                    <div className='stripe retail visible widthNormal'>
                        <h4 className={work_sans.className}>Retail</h4>
                    </div>
                </Link>
                <Link href=''>
                    <div className='stripe community visible widthNormal'>
